"""Clasificador ONNX para madurez de pimientos."""

import cv2
import numpy as np
import onnxruntime as ort

from src.config import ONNX_CLS_INDEX
...
class OnnxClassifier:
    ...
    def classify(self, crop: np.ndarray) -> tuple[RipenessClass, float]:
        """Clasifica un crop. Retorna (RipenessClass, confidence).
        ...
        return ONNX_CLS_INDEX[top_idx], float(probs[top_idx])
